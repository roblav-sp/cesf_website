---
title: "Bienvenue au CESF"
description: "Philosophie Spirite à Montréal — Pour comprendre la raison de la vie"
---

{{< button href="/fr/atividades/" target="_self" >}}
Voir Nos Activités →
{{< /button >}}

## Bienvenue au Centre d'Études Spirites Fraternité!
...
- **Activités d'étude** basique et approfondie sur le spiritisme
- **Soins spirituels** et passes d'équilibre pour les centres de force
- **Traitement et développement spirituel**
- **Activités pour le développement de la médiumnité** spirite
